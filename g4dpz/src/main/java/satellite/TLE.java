...
public class TLE implements Serializable {
    ...
    private static final int FOURLINES = 4;
    private static final int FIVELINES = 5;
    ...
    public TLE(final String[] tle, final boolean nilStart) throws IllegalArgumentException {
        ...
        name = tle[0].trim();
        int setnum = Integer.parseInt((tle[1].substring(64, 68)).trim());
        ...
        double raan = Double.parseDouble(tle[2].substring(17, 25));
        eccn = 1.0e-07 * Double.parseDouble(tle[2].substring(26, 33));
        double argper = Double.parseDouble(tle[2].substring(34, 42));
        double meanan = Double.parseDouble(tle[2].substring(43, 51));
        meanmo = Double.parseDouble(tle[2].substring(52, 63));
        double drag = Double.parseDouble(tle[1].substring(33, 43));
        category = tle[3];
        double tempnum = 1.0e-5 * Double.parseDouble(tle[1].substring(44, 50));
        double nddot6 = tempnum
        ...
        int orbitnum = Integer.parseInt((tle[2].substring(63, 68)).trim());
    ...
    public void setLookAngleAz(double lookAngleAz) {
        this.lookAngleAz = lookAngleAz;
    }
    ...
    public void setLookAngleEl(double lookAngleEl) {
        this.lookAngleEl = lookAngleEl;
    }
