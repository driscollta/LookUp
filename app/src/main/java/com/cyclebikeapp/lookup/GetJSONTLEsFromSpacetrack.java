...
/**
 * Created by TommyD on 3/7/2018.
 */

public class GetJSONTLEsFromSpacetrack {

        private static final String JSON_KEY_NORAD_CAT_ID = "NORAD_CAT_ID";
        private static final String baseURL = "https://www.space-track.org";
        private static final String authPath = "/auth/login";
        private static final String userName = "cyclebikeapp@gmail.com";
        private static final String password = "cyclebikeapp5431";


        JSONArray fetchTLEs(String query, String satelliteKind) {
